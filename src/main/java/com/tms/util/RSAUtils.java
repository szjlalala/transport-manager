...
/**
 * Package Name:com.ylpw.core.util ClassName: RSAUtils Description：
 */
public abstract class RSAUtils {
    ...
    private static synchronized KeyPair generateKeyPair() {
        try {
            keyPairGen.initialize(KEY_SIZE, new SecureRandom(DateUtils.getDate("yyyyMMdd").getBytes()));
