...
public class TableColumn {
     ...
     * 标识是否对该列标识背景颜色
     */
    private boolean isMarkBGColor = false;
    ...
    public boolean isMarkBGColor() {
        return isMarkBGColor;
    }

    public void setMarkBGColor(boolean isMarkBGColor) {
        this.isMarkBGColor = isMarkBGColor;
    }
