...
//			tc.setGrouped(true);
     ...
     * @return
     */
    public static TableHeaderMetaData createTableHeaderForMarkBgColor(String[] titls, Set<String> formartCloumn, String[] fileds) {
        TableHeaderMetaData headMeta = new TableHeaderMetaData();
        TableColumn tc = null;
        for (int i = 0; i < titls.length; i++) {
            ...
            headMeta.addColumn(tc);
            if (formartCloumn.contains(fileds[i]))
                tc.setMarkBGColor(true);
        }
        return headMeta;
    }
    ...
    public static String getWeekOfDay(Calendar cal) {
